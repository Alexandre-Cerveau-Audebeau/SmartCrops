...
- **Ce qui a été fait** : PRs mergées (numéro + SHA squash + date + nb de rounds CR), features livrées, tickets clos. Données chiffrées (tests avant→après, lignes, volumes DB).
