// Material Symbols `potted_plant` (Apache-2.0, google/material-design-icons,
// downloaded by the owner — see icons/raw/potted_plant_24px.svg).
export function ModeIconPlace() {
  return (
    <svg
