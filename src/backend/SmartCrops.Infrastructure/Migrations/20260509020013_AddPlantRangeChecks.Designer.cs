...
namespace SmartCrops.Infrastructure.Migrations
{
    ...
    [Migration("20260509020013_AddPlantRangeChecks")]
    partial class AddPlantRangeChecks
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Plants", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Plants_Height_Range", "\"MinHeightCm\" IS NULL OR \"MaxHeightCm\" IS NULL OR \"MinHeightCm\" <= \"MaxHeightCm\"");
                            ...
                            t.HasCheckConstraint("CK_Plants_Spread_Range", "\"MinSpreadCm\" IS NULL OR \"MaxSpreadCm\" IS NULL OR \"MinSpreadCm\" <= \"MaxSpreadCm\"");
